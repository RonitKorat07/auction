...
const Footer = () => {
  ...
  const sponsors = [
    {
      name: "Tata Motors",
      logo: "https://seeklogo.com/images/T/TATA-logo-B17191F4CA-seeklogo.com.png",
    },
    {
      name: "Adidas",
      logo: "https://images.seeklogo.com/logo-png/30/1/jio-logo-png_seeklogo-305444.png",
    },
    {
      name: "CEAT Tyres",
      logo: "https://images.seeklogo.com/logo-png/2/1/ceat-tyres-logo-png_seeklogo-27738.png",
    },
    {
      name: "Dream11",
      logo: "https://seeklogo.com/images/D/dream11-logo-A5D7BB9B54-seeklogo.com.png",
    },
  ];
          ...
          <div className="flex flex-col md:flex-row justify-between items-start mb-12">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-300 max-w-md">
                Experience the thrill of cricket's biggest festival. The Indian
                Premier League - where talent meets opportunity.
              </p>
            </div>
