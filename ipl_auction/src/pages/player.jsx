...
const Player = () => {
  ...
  const filteredPlayers = players
    .filter((player) => {
      ...
      const statusMatch = selectedStatus === "All" || player.player_role === selectedStatus;
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="rounded-lg shadow-2xl p-4 sm:p-8 text-gray-200 bg-white/5 backdrop-blur-sm">
              ...
              <div className="mb-8 bg-transparent rounded-xl p-6 sm:p-8 text-white relative h-10 justify-center flex">
                <h1 className="absolute text-[30px] lg:text-[50px] md:text-[40px] top-0 text-gray-200 font-serif">
                  IPL PLAYERS
                </h1>
              </div>
                ...
                <table className="min-w-full divide-y divide-gray-700">
                  <thead>
                    <tr className="text-gray-200 bg-darkgray/50 backdrop-blur-sm">
                      ...
                      <th className="px-6 py-3 text-center text-l font-medium text-gray-300 uppercase tracking-wider w-1/10"></th>
                    </tr>
                  </thead>
                    ...
                    {filteredPlayers.map((player) => (
                      <tr key={player.id} className="hover:bg-white/10 transition-all">
                        ...
                        <td className="px-6 py-4 text-center whitespace-nowrap text-sm">
                          <Link to={`/playerprofile/${player.id}`} className="text-gray-400 hover:text-gray-300 p-2 transition-colors">
                            View
                          </Link>
                        </td>
                      </tr>
