...
const Display = () => {
  ...
  return (
    <div className="h-auto absolute w-full bg-[#202626]  pt-20">
          ...
          {player.map((player, index) => (
            ...
            <div key={index} className="bg-white/10 rounded-lg shadow-md overflow-hidden backdrop-blur-sm border border-white/20">
              <img 
                ...
                onError={(e) => {
                  e.target.src = 'https://via.placeholder.com/300x200?text=Player+Image' // Using placeholder image as fallback
                }}
              />
              <div className="p-4">
