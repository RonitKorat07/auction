  ...
  useEffect(() => {
    ...
    if (statsChartRef.current) {
      ...
      const option = {
        ...
        xAxis: {
          type: "category",
          data: ["Matches", "Runs", "Wickets", "Average", "SR"],
        },
        yAxis: { type: "value" },
        series: [
          {
              ...
              {[
                {
                  ...
                  icon: <FaUserAlt className="text-blue-400" />,
                },
                {
                  label: "DOB",
                  value: "16 Aug 1989",
            ...
            <div className="bg-gradient-to-br from-black to-gray-900 backdrop-blur-lg rounded-xl p-6 shadow-2xl border border-gray-800 h-[680px] overflow-y-auto">
              ...
              <div className="space-y-3">
                {bidHistory.map((bid, index) => (
                  <div
                    key={index}
                    className="bg-gray-800/50 rounded-lg p-3 backdrop-blur-sm border border-gray-700"
                  >
